...
{{
  "catch_copy": "メインキャッチコピー（20〜30文字。ターゲットの悩みを直撃する一言。意味の区切りで改行したい位置に\\nを入れること。例：「長年の腰痛が、\\nたった1回で変わった。」）",
  "sub_copy": "サブキャッチコピー（30〜50文字。キャッチコピーを補足する文）",
  "pain_section": {{
    "headline": "「こんな悩みありませんか？」セクションの見出し",
    "items": [
      {{"text": "悩み1の見出し（15文字以内）", "sub": "悩み1の補足説明（30〜50文字。体験談調で共感できる文章）"}},
      {{"text": "悩み2の見出し", "sub": "悩み2の補足説明"}},
      {{"text": "悩み3の見出し", "sub": "悩み3の補足説明"}}
    ]
  }},
  "empathy_text": "院の強みを2〜3つ端的に挙げ、最後は「（院名）が解決します。」で締める文章（60〜100文字）。共感より解決の提示を優先する。",
  "solution_section": {{
