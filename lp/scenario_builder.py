        ...
        # ─── シナリオC-分岐A｜口コミ候補（星4〜5） ─────────────────
        {
            ...
            "steps": [
                ...
                {"stepOrder": 3, "delayMinutes": 0, "deliveryHour": None, "messageType": "text",
                 "messageContent": R("一つお願いがあります。\n\n先ほどご入力いただいた内容を、Googleマップの口コミとして投稿していただけませんか？\n\n同じようなお悩みを抱えて、どこに行けばいいか迷っている方の大きな参考になります。\n{{name}}さんの体験が、誰かの最初の一歩を後押しできるかもしれません。\n\n次のメッセージにご入力内容をそのまま送りますので、長押しでコピーしてお使いください。")},
                {"stepOrder": 4, "delayMinutes": 0, "deliveryHour": None, "messageType": "text",
                 "messageContent": "{{metadata.comment}}"},
                {"stepOrder": 5, "delayMinutes": 0, "deliveryHour": None, "messageType": "text",
                 "messageContent": R("コピーできたら、こちらのボタンからGoogleマップを開いて貼り付けるだけです。\n新たに文章を考える必要はありません。")},
